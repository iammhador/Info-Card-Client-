...
import ProfileImage from "../../Assets/ProfilePhoto/faravi.jpg";
  ...
  return (
    <div>
      ...
      <div className="mt-14 px-5">
        <h3 className="text-2xl font-bold">Faravi Khan</h3>
        <h5 className="text-lg font-medium">Student</h5>
        <p className="mt-2 text-justify">
          I am an undergraduate student and a part time mobile gamer
        </p>
        ...
        <div className="my-8">
          ...
          <div className="my-4">
            <a
              href="mailto:faravi.infocard@gmail.com"
              class="flex my-auto mb-4"
            >
              <MdEmail className="text-5xl rounded-full bg-black text-white p-3" />
              <div className="ml-3">
                <h4 className="text-base font-medium">
                  faravi.infocard@gmail.com
                </h4>
                <p className="text-xs">Email</p>
              </div>
            </a>

            <a href="tel:+8801814229050" class="flex my-auto mb-4">
              <MdCall className="text-5xl rounded-full bg-black text-white p-3" />
              <div className="ml-3">
                <h4 className="text-base font-medium">+8801814229050</h4>
                <p className="text-xs">Cell Phone</p>
              </div>
            </a>

            <a
              href="https://www.linkedin.com/in/faravi-khan-23091b262/"
              target="a_blank"
              class="flex my-auto mb-4"
            >
        ...
        <div className="my-8">
          ...
          <div className="grid grid-cols-3 my-4 justify-items-center">
            <a href="https://www.facebook.com/faravi.khan.3" target="a_blank">
              <img src={facebook} alt="facebook" className="w-16 mb-7" />
            </a>
            <a href="https://www.instagram.com/zujoker/" target="a_blank">
              <img src={instagram} alt="instagram" className="w-16 mb-7" />
            </a>

            <a href="https://wa.me/+8801814229050" target="a_blank">
